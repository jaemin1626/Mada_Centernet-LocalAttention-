...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--exp_id', default='coco_hg') # 수정
    ...
    self.parser.add_argument('--demo', default='', 
                             help='path to image/ image folders/ video. '
                                  'or "webcam"')
    self.parser.add_argument('--load_model', default='/home/ai001/MadaCenternet_(LocalAttention)/save_dir/2023_data/Centernet_2023/model_last.pth', # 수정
    ...
    self.parser.add_argument('--num_workers', type=int, default=2, # 수정
    ...
    # model
    self.parser.add_argument('--arch', default='hourglass',  # 수정
                             help='model architecture. Currently tested'
                                  'res_18 | res_101 | resdcn_18 | resdcn_101 |'
                                  'dlav0_34 | dla_34 | hourglass | hourglass_multi_scale')
    ...
    self.parser.add_argument('--batch_size', type=int, default=5, # 수정
                             help='batch size')
    self.parser.add_argument('--master_batch_size', type=int, default=5, # 수정
  ...
  def parse(self, args=''):
    ...
    opt.save_dir = '/home/ai001/MadaCenternet_(LocalAttention)/save_dir/Centernet_2023'
